...
from pump_app.model_classes.SubscriptionState import SubscriptionState, SubscriptionActive
import datetime
...
class Subscription(models.Model):
    ...
    def evalEndDateStandardPacket(self, packets, sale):
        from pump_app.model_classes.Packet import StandardPacket
    ...
    def evalEndDateCustomPacket(self, packets, sale):
        from pump_app.model_classes.Packet import CustomPacket
    ...
    def setStateActive(self):
        self.state = SubscriptionActive.objects.all()[0]
        self.save()
        return self.state
